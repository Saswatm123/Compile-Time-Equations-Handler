...
OPER both_known_ret_type<const known_check_A, const known_check_B>
operator^(const known_check_A& lhs, const known_check_B& rhs)
{
    return static_cast<long double>(std::pow(lhs.value, rhs.value));
}
...
{
    return static_cast<long double>(std::pow(lhs.value, rhs));
}
...
{
    return op_tree<long double, unknown_check_RHS>(OpType<long double, unknown_check_RHS>::exp, static_cast<long double>(lhs.value), rhs);
}
...
{
    return op_tree<long double, is_op_tree>(OpType<long double, is_op_tree>::exp, static_cast<long double>(lhs.value), rhs);
}
...
{
    return op_tree<long double, unknown_check_RHS>(OpType<long double, unknown_check_RHS>::exp, lhs, rhs);
}
...
{
    return op_tree<long double, is_op_tree>(OpType<long double, is_op_tree>::exp, lhs, rhs);
}
...
{
    return op_tree<unknown_check_LHS, long double>(OpType<unknown_check_LHS, long double>::exp, lhs, static_cast<long double>(rhs.value));
}
...
{
    return op_tree<unknown_check_LHS, long double>(OpType<unknown_check_LHS, long double>::exp, lhs, rhs);
}
...
{
    return op_tree<unknown_check_LHS, unknown_check_RHS>(OpType<unknown_check_LHS, unknown_check_RHS>::exp, lhs, rhs);
}
...
{
    return op_tree<unknown_check_LHS, is_op_tree>(OpType<unknown_check_LHS, is_op_tree>::exp, lhs, rhs);
}
...
{
    return op_tree<is_op_tree, long double>(OpType<is_op_tree, long double>::exp, lhs, static_cast<long double>(rhs.value));
}
...
{
    return op_tree<is_op_tree, long double>(OpType<is_op_tree, long double>::exp, lhs, rhs);
}
...
{
    return op_tree<is_op_tree, unknown_check_RHS>(OpType<is_op_tree, unknown_check_RHS>::exp, lhs, rhs);
}
...
{
    return op_tree<A,B>(OpType<A,B>::exp, lhs, rhs);
}
